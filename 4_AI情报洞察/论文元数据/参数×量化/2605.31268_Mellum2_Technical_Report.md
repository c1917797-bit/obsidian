...
key_innovation: "核心创新：首个开源MoE模型，专注软件工程，拥有12B参数且每词激活2.5B参数。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Marko Kojic, Ivan Bondyrev, Aral de Moor |
...
- **PDF**: https://arxiv.org/pdf/2605.31268
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
