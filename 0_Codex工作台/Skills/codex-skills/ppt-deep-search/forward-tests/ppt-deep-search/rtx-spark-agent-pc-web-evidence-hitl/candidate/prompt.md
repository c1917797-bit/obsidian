...
```text
skills/ppt-deep-search/forward-tests/ppt-deep-search/rtx-spark-agent-pc-web-evidence-hitl/candidate/input/source-request.md
```

允许按 skill 流程使用子 agent，包括网页抓取、Source Understanding HTML deck 生成和视觉 QA。
