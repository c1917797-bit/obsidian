...
pdf_url: "https://arxiv.org/pdf/2508.10012"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.10012](https://arxiv.org/abs/2508.10012) |
| **4×5分类** | 参数×低秩 |
| **来源** | deep_collect_v2_supp |
| **作者** | Dehao Tao, Guangjie Liu, Weizheng |
...
- **PDF**: https://arxiv.org/pdf/2508.10012
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
