...
pdf_url: "https://arxiv.org/pdf/2603.11139"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects: []
...
| **作者** | Amit Singh, Vedant Nipane, Pulkit Agrawal |
...
- **PDF**: https://arxiv.org/pdf/2603.11139
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
