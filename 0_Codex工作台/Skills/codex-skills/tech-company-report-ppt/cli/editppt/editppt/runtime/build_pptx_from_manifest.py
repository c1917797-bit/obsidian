# Vendored and adapted from ningzimu/image-to-editable-ppt-skill
# Commit fb869763127fd31ba7288d905671ffc4ea542f60; MIT License.
#!/usr/bin/env python3
import argparse
import html
import json
...
def shape_xml(idx, item):
    ...
    return f"""
      <p:sp>
        ...
        <p:txBody><a:bodyPr/><a:lstStyle/><a:p><a:endParaRPr lang="zh-CN" sz="1200"/></a:p></p:txBody>
      </p:sp>"""
...
def presentation_rels_xml(slide_count):
    ...
    rels.extend([
        ...
        f'<Relationship Id="rId{next_id + 2}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme" Target="theme/theme1.xml"/>',
        f'<Relationship Id="rId{next_id + 3}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/tableStyles" Target="tableStyles.xml"/>',
    ])
...
def write_common_parts(z, slide_count, width, height, notes_count):
    ...
    z.writestr("ppt/viewProps.xml", """<?xml version="1.0" encoding="UTF-8" standalone="yes"?><p:viewPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"><p:normalViewPr><p:restoredLeft sz="15611"/><p:restoredTop sz="94658"/></p:normalViewPr><p:slideViewPr><p:cSldViewPr snapToGrid="0"><p:cViewPr varScale="1"><p:scale><a:sx n="100" d="100"/><a:sy n="100" d="100"/></p:scale><p:origin x="0" y="0"/></p:cViewPr><p:guideLst/></p:cSldViewPr></p:slideViewPr><p:notesTextViewPr><p:cViewPr><p:scale><a:sx n="1" d="1"/><a:sy n="1" d="1"/></p:scale><p:origin x="0" y="0"/></p:cViewPr></p:notesTextViewPr><p:gridSpacing cx="72008" cy="72008"/></p:viewPr>""")
