...
pdf_url: "https://arxiv.org/pdf/2603.05806"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects:
...
| **作者** | Marmik Chaudhari, Idhant Gulati, Nishkal Hundia |
...
- **PDF**: https://arxiv.org/pdf/2603.05806
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
