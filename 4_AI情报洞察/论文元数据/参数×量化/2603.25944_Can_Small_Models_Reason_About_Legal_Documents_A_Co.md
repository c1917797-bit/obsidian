...
pdf_url: "https://arxiv.org/pdf/2603.25944"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
key_innovation: "核心创新：首次证实3B专家模型在法律推理任务中可匹敌GPT-4o-mini且成本更低。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.25944](https://arxiv.org/abs/2603.25944) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Snehit Vaddi |
...
- **PDF**: https://arxiv.org/pdf/2603.25944
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
