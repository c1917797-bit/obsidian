...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.17920](https://arxiv.org/abs/2512.17920) |
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Rahul Baxi |
...
- **PDF**: https://arxiv.org/pdf/2512.17920
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
