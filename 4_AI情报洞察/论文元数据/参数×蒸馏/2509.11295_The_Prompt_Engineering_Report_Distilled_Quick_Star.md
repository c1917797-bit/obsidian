...
pdf_url: "https://arxiv.org/pdf/2509.11295"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.11295](https://arxiv.org/abs/2509.11295) |
| **4×5分类** | 参数×蒸馏 |
...
- **PDF**: https://arxiv.org/pdf/2509.11295
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
