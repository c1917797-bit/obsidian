# Main Agent Prompt: Run GOAL-MEM HITL Forward Test

Run the forward test at:

```text
forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl
```
...
- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/fixture-manifest.md`
- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/judge/rubric.md`

Confirm the candidate-facing input exists:

- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/prompt.md`
- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/input/source-request.md`
...
Use `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/judge/rubric.md` to judge the output.
