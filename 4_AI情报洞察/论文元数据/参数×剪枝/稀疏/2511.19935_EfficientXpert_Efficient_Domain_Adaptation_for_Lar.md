...
citekey: zhao2025efficientxpert
...
pdf_url: "https://arxiv.org/pdf/2511.19935"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2511.19935](https://arxiv.org/abs/2511.19935) |
| **4×5分类** | 参数×剪枝/稀疏 |
...
- **PDF**: https://arxiv.org/pdf/2511.19935
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
