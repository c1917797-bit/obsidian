...
pdf_url: "https://arxiv.org/pdf/2605.18379"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "提出了一种新的显式因子分解方法，在多轮差分隐私学习中实现高效内存利用和性能提升。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2605.18379](https://arxiv.org/abs/2605.18379) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Nikita P. Kalinin, Aki Rehn, Joel Daniel Andersson |
...
- **PDF**: https://arxiv.org/pdf/2605.18379
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
