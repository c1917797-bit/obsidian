...
pdf_url: "https://arxiv.org/pdf/2603.02234"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects:
...
| **作者** | Davide Ferre', Frédéric Giroire, Frederik Mallmann-Trenn |
...
- **PDF**: https://arxiv.org/pdf/2603.02234
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
