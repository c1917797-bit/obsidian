...
pdf_url: "https://arxiv.org/pdf/2601.03199"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：DIP提出动态调整扩散模型上下文，在保证生成质量的同时降低计算成本。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2601.03199](https://arxiv.org/abs/2601.03199) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yang Li, Han Meng, Chenan Wang |
...
- **PDF**: https://arxiv.org/pdf/2601.03199
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
