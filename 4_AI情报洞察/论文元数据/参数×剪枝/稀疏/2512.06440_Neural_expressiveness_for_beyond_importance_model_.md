...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.06440](https://arxiv.org/abs/2512.06440) |
| **4×5分类** | 参数×剪枝/稀疏 |
...
- **PDF**: https://arxiv.org/pdf/2512.06440
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
