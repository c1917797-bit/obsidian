...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=PVOipVYONz"
pdf_url: ""
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
...
abstract: |
  ...
  \AGIL~ utilizes the pretrained DM to generate samples with diverse state observations for
...
| **4×5分类** | 参数×蒸馏 |
| **来源** | openreview |
| **作者** | Linrui Gong, Zihao Liu, Lihao Liu |
