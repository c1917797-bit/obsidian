...
pdf_url: "https://arxiv.org/pdf/2605.30836"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects:
...
key_innovation: "核心创新：将跨层子空间耦合统一为优化问题，改进权重重建误差46%。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2605.30836](https://arxiv.org/abs/2605.30836) |
| **4×5分类** | 参数×低秩 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2605.30836
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
