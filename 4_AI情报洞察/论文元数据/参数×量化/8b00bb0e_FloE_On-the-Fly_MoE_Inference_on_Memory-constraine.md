...
abstract: |
  ...
  While offloading expert parameters to CPU memory and loading activated experts on demand has emerged as a potential solution, the large size of activated
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Yuxin Zhou, zheng li, Jun Zhang |
