...
arxiv_id: "2605.20872"
doi: ""
url: "https://arxiv.org/abs/2605.20872"
pdf_url: "https://arxiv.org/pdf/2605.20872"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
key_innovation: "提出CAdam算法，通过自适应上下文调整优化3D高斯点云生成蒸馏中的密度化过程。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2 |
| **作者** | SeungJeh Chung, Geonho Park, Misong Kim |
...
- **PDF**: https://arxiv.org/pdf/2605.20872
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
