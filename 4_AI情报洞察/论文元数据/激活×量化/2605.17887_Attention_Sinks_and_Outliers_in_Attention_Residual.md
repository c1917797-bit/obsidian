...
pdf_url: "https://arxiv.org/pdf/2605.17887"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2605.17887](https://arxiv.org/abs/2605.17887) |
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Haozheng Luo, Haoran Dai, Shaoyang Zhang |
...
- **PDF**: https://arxiv.org/pdf/2605.17887
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
