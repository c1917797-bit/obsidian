...
pdf_url: "https://arxiv.org/pdf/2603.07615"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects: []
...
| **作者** | Zongyu Guo, Jiajun He, Zhaoyang Jia |
...
- **PDF**: https://arxiv.org/pdf/2603.07615
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
