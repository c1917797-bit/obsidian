...
| **作者** | Longxiang Zhang, Weilong Dai, Guanghao Zhang |
...
- **PDF**: https://arxiv.org/pdf/2605.14448
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
