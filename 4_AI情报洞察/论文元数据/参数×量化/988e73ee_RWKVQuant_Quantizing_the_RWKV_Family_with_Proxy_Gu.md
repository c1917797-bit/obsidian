...
abstract: |
  ...
  Post Training Quantization (PTQ), which is a an essential technique to reduce model size and inference latency, has been widely used in Transformer
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | XUCHEN, Yuxuan Yue, Zukang Xu |
