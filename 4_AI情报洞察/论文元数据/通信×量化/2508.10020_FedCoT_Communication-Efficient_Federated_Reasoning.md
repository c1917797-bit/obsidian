...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.10020](https://arxiv.org/abs/2508.10020) |
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Chuan Li, Qianyi Zhao, Fengran Mo |
...
- **PDF**: https://arxiv.org/pdf/2508.10020
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
