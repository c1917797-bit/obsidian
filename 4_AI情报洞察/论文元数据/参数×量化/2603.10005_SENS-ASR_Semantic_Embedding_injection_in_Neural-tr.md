...
pdf_url: "https://arxiv.org/pdf/2603.10005"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：将语义嵌入注入神经传导器，提升流式语音识别准确率。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.10005](https://arxiv.org/abs/2603.10005) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Youness Dkhissi, Valentin Vielzeuf, Elys Allesiardo |
...
- **PDF**: https://arxiv.org/pdf/2603.10005
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
