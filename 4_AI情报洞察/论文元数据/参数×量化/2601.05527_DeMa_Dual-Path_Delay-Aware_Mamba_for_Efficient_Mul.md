...
pdf_url: "https://arxiv.org/pdf/2601.05527"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "提出了双路径延迟感知Mamba（Dual-Path Delay-Aware Mamba）架构，用于高效的多变量时间序列分析。"
performance: "未提数字"
code_url: "未开源"
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2601.05527](https://arxiv.org/abs/2601.05527) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Rui An, Haohao Qu, Wenqi Fan |
...
- **PDF**: https://arxiv.org/pdf/2601.05527
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
