...
abstract: |
  ...
  While Variational Autoencoders (VAEs) offer improved efficiency by operating in the latent space, with the Gaussian variational constraint, this compression preserves semantics but sacri
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Yidi Liu, Xueyang Fu, Jie Huang |
