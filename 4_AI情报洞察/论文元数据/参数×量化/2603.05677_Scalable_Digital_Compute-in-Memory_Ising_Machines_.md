...
citekey: vadlamani2026scalable
title: "Scalable Digital Compute-in-Memory Ising Machines for Robustness Verification of Binary Neural Networks"
authors:
  - "Madhav Vadlamani"
  - "Rahul Singh"
  - "Yuyao Kong"
...
arxiv_id: "2603.05677"
doi: ""
url: "https://arxiv.org/abs/2603.05677"
pdf_url: "https://arxiv.org/pdf/2603.05677"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.05677](https://arxiv.org/abs/2603.05677) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Madhav Vadlamani, Rahul Singh, Yuyao Kong |
...
- **PDF**: https://arxiv.org/pdf/2603.05677
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
