...
key_innovation: "开发了GPU加速的INT8量化算法，实现了KV缓存4倍压缩和最高1694倍加速。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2601.04719](https://arxiv.org/abs/2601.04719) |
| **4×5分类** | KV×量化 |
...
- **PDF**: https://arxiv.org/pdf/2601.04719
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
