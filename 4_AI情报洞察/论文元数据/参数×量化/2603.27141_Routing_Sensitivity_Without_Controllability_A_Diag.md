...
pdf_url: "https://arxiv.org/pdf/2603.27141"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出FARE框架，揭示MoE模型在路由层干预公平性的结构性限制。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.27141](https://arxiv.org/abs/2603.27141) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2603.27141
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
