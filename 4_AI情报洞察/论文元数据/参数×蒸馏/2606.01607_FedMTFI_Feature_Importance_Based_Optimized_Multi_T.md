...
pdf_url: "https://arxiv.org/pdf/2606.01607"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects:
...
key_innovation: "核心创新：在异构联邦学习环境下，基于特征重要性的优化多教师知识蒸馏。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2606.01607](https://arxiv.org/abs/2606.01607) |
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2 |
| **作者** | Nazmus Shakib Shadin, Aaron Cummings, Xinyue Zhang |
...
- **PDF**: https://arxiv.org/pdf/2606.01607
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
