...
abstract: |
  ...
  However, deploying existing safety guard models with billions of parameters alongside LLMs on mobile devices is
...
| **4×5分类** | 参数×蒸馏 |
| **来源** | arXiv |
| **作者** | Seanie Lee, Haebin Seong, Dong Bok Lee |
