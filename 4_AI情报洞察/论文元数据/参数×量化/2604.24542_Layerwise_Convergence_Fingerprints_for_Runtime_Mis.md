...
pdf_url: "https://arxiv.org/pdf/2604.24542"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2604.24542](https://arxiv.org/abs/2604.24542) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2604.24542
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
