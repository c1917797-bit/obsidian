...
arxiv_id: "2509.13268"
doi: ""
url: "https://arxiv.org/abs/2509.13268"
...
all_methods:
  - "量化"
abstract: |
  BACKGROUND: Most artificial intelligence tools used to estimate nutritional content rely on image input. However, whether large language models (LLMs) can accurately predict nutritional values based solely on text descriptions of foods consumed remains unknown. If effective, this approach could enable simpler dietary monitoring without the need for photographs. METHODS: We used 24-hour dietary recalls from adolescents aged 12-19 years in the National Health and Nutrition Examination Survey (NHANES). An open-source quantized LLM was prompted using a 10-shot, chain-of-thought approach to estimat
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.13268](https://arxiv.org/abs/2509.13268) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2509.13268
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
