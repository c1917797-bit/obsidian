...
pdf_url: "https://arxiv.org/pdf/2603.21105"
object: 激活
method: 剪枝/稀疏
cell: "激活×剪枝/稀疏"
all_objects:
...
| **4×5分类** | 激活×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Xu Li, Yi Zheng, Yuxuan Liang |
...
- **PDF**: https://arxiv.org/pdf/2603.21105
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
