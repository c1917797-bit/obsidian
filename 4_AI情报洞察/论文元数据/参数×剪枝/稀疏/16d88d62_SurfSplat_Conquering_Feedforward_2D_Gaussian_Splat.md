...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=o1sF4XaFdY"
pdf_url: ""
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
...
abstract: |
  ...
  To address this issue, we present SurfSplat, a feedforward framework based on 2D Gaussian Splatting (2DGS) primitive, wh
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Bing He, Jingnan Gao, Yunuo Chen |
