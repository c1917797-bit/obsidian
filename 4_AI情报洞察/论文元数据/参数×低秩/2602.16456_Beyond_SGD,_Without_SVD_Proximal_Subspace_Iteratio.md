...
pdf_url: "https://arxiv.org/pdf/2602.16456"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects:
...
| **4×5分类** | 参数×低秩 |
| **来源** | deep_collect_v2 |
| **作者** | Abdulla Jasem Almansoori, Maria Ivanova, Andrey Veprikov |
...
- **PDF**: https://arxiv.org/pdf/2602.16456
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
