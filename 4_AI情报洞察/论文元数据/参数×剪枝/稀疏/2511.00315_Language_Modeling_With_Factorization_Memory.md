...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2511.00315](https://arxiv.org/abs/2511.00315) |
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Lee Xiong, Maksim Tkachenko, Johanes Effendi |
...
- **PDF**: https://arxiv.org/pdf/2511.00315
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
