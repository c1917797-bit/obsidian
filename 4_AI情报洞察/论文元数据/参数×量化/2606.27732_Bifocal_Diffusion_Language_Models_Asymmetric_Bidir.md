...
pdf_url: "https://arxiv.org/pdf/2606.27732"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出双焦扩散语言模型，结合双向和因果注意力，实现高效并行生成。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2606.27732](https://arxiv.org/abs/2606.27732) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yuhang Chen, Xianfeng Wu, Jinhao Duan |
...
- **PDF**: https://arxiv.org/pdf/2606.27732
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
