...
abstract: |
  ...
  While this approach is effective in solving problems that require logical thinking, long reasoning paths significantly increase memory usage and reduce th
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Jiwon Song, Dongwon Jo, Yulhwa Kim |
