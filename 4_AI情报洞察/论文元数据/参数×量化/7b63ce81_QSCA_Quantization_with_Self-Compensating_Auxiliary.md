...
abstract: |
  ...
  However, the deployment on resource-constrained devices remains challenging due to the high computation and memory requ
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Jincheol Yang, Jaemin Choi, Matti Alexander Zinke |
