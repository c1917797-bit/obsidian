...
pdf_url: "https://arxiv.org/pdf/2507.23588"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2507.23588](https://arxiv.org/abs/2507.23588) |
| **4×5分类** | 参数×低秩 |
| **来源** | deep_collect_v2 |
| **作者** | Alexandre Misrahi, Nadezhda Chirkova, Maxime Louis |
...
- **PDF**: https://arxiv.org/pdf/2507.23588
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
