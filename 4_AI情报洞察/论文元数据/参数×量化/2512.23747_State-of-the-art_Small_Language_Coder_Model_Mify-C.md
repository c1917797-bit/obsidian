...
pdf_url: "https://arxiv.org/pdf/2512.23747"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.23747](https://arxiv.org/abs/2512.23747) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Abhinav Parmar, Abhisek Panigrahi, Abhishek Kumar Dwivedi |
...
- **PDF**: https://arxiv.org/pdf/2512.23747
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
