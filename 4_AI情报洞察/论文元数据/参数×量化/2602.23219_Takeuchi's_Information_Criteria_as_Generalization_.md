...
pdf_url: "https://arxiv.org/pdf/2602.23219"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **作者** | Hiroki Naganuma, Taiji Suzuki, Rio Yokota |
...
- **PDF**: https://arxiv.org/pdf/2602.23219
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
