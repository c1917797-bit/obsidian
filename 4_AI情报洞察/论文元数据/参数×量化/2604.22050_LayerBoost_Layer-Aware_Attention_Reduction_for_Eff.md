...
citekey: souibgui2026layerboost
...
pdf_url: "https://arxiv.org/pdf/2604.22050"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2604.22050](https://arxiv.org/abs/2604.22050) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Mohamed Ali Souibgui, Jan Fostier, Rodrigo Abadía-Heredia |
...
- **PDF**: https://arxiv.org/pdf/2604.22050
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
