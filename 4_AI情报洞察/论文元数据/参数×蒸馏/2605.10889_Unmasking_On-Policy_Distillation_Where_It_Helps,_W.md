...
citekey: armandpour2026unmasking
...
pdf_url: "https://arxiv.org/pdf/2605.10889"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
| **作者** | Mohammadreza Armandpour, Fatih Ilhan, David Harrison |
...
- **PDF**: https://arxiv.org/pdf/2605.10889
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
