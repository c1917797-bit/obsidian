...
Adapted from ningzimu/image-to-editable-ppt-skill at commit
fb869763127fd31ba7288d905671ffc4ea542f60 (MIT License).
"""
...
def page_worker_template() -> str:
    text = (SKILL_ROOT / "prompts" / "upstream-page-worker.md").read_text(encoding="utf-8")
    marker = "```text"
