...
citekey: shuvo2026polite
title: "Polite on the Surface, Broken in Practice: A Curated Dataset for Fixing Generation and Register Failures in Low-Resource Bangla Text Generation"
authors:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2605.22487](https://arxiv.org/abs/2605.22487) |
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Md. Asaduzzaman Shuvo, Mahedi Hasan, Md. Tashin Parvez |
...
- **PDF**: https://arxiv.org/pdf/2605.22487
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
