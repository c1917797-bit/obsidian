...
citekey: li2026on
title: "On the Efficiency of Structured Pruning in Small Language Model Pretraining"
authors:
  - "Yixiao Li"
  - "Xianzhi Du"
  - "AJAY KUMAR JAISWAL"
...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=KVUMuxHNLW"
pdf_url: ""
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
...
abstract: |
  ...
  However, while structured pruning has shown promise comp
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Yixiao Li, Xianzhi Du, AJAY KUMAR JAISWAL |
