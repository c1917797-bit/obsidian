...
pdf_url: "https://arxiv.org/pdf/2603.01820"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **作者** | Adir Saly-Kaufmann, Kieran Wood, Jan Peter-Calliess |
...
- **PDF**: https://arxiv.org/pdf/2603.01820
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
