...
abstract: |
  ...
  The Mixture-of-Experts (MoE) architecture stands out for its ability to scale model size without significantly increasing trai
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Zihan Qiu, Zeyu Huang, Shuang Cheng |
