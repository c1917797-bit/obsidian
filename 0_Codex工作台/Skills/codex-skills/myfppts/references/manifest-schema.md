...
<!-- Adapted from ningzimu/image-to-editable-ppt-skill at commit fb869763127fd31ba7288d905671ffc4ea542f60 (MIT). -->
...
For an original screenshot, photograph, or illustration explicitly named in
`deck_spec.json`, keep it as an independent replaceable image and record
`source_type: "user-provided"`, `original_asset: true`, and its contract
`asset_id`. This exception applies only to the original asset file. It does not
permit extracting a crop from the flattened design draft.
