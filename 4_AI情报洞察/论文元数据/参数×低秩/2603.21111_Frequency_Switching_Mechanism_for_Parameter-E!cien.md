...
pdf_url: "https://arxiv.org/pdf/2603.21111"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects:
...
| **作者** | Shih-Wen Liu, Yen-Chang Chen, Wei-Ta Chu |
...
- **PDF**: https://arxiv.org/pdf/2603.21111
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
