...
abstract: |
  ...
  While recent advances extend 3D Gaussian Splatting to dynamic scenes via various motion anchors, such as graph nodes or spline control points, the
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Junyi Wu, Jiachen Tao, Haoxuan Wang |
