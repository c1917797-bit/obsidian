...
pdf_url: "https://arxiv.org/pdf/2606.26607"
object: 通信
method: 量化
cell: "通信×量化"
all_objects:
...
all_methods: []
abstract: |
  Mixture-of-Experts (MoE) architectures scale large language models (LLMs) to hundreds of billions of parameters. Serving a single MoE model requires multiple GPUs operating in parallel, typically through tensor parallelism (TP) or expert parallelism (EP). The optimal choice depends on the number of in-flight requests: TP is faster at low concurrency, whereas EP wins at high concurrency. Production workloads cross this boundary continually: online serving sees bursty arrivals that subside into quiet periods, and reinforcement-learning rollouts begin as a high-concurrency burst that decays into
key_innovation: "核心创新：提出Moebius系统，动态切换张量并行和专家并行，提升MoE模型服务效率。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Shaoyu Wang, Yizhuo Liang, Jaeyong Song |
