...
pdf_url: "https://arxiv.org/pdf/2511.05534"
object: KV
method: 量化
cell: "KV×量化"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2511.05534](https://arxiv.org/abs/2511.05534) |
| **4×5分类** | KV×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Kunxi Li, Yufan Xiong, Zhonghua Jiang |
...
- **PDF**: https://arxiv.org/pdf/2511.05534
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
