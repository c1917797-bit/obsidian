...
pdf_url: "https://arxiv.org/pdf/2603.16440"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
- **PDF**: https://arxiv.org/pdf/2603.16440
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
