...
citekey: sarfi2025communication
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.15706](https://arxiv.org/abs/2508.15706) |
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Amir Sarfi, Benjamin Thérien, Joel Lidin |
...
- **PDF**: https://arxiv.org/pdf/2508.15706
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
