...
abstract: |
  ...
  Cross-entropy builds up a logit matrix with entries for each pair of input tokens and vocabu
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Erik Wijmans, Brody Huval, Alexander Hertzberg |
