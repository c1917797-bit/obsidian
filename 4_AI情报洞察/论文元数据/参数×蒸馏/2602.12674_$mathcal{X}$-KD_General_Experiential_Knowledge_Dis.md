...
pdf_url: "https://arxiv.org/pdf/2602.12674"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
- **PDF**: https://arxiv.org/pdf/2602.12674
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
