...
abstract: |
  ...
  Although model compression and parameter offloading are common strategies to address memory limitations, compression can degrade quality, and offloading maintains quality but suffers fro
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Pei-Shuo Wang, Jian-Jia Chen, Chun-Che Yang |
