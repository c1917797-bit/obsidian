...
pdf_url: "https://arxiv.org/pdf/2602.02151"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.02151](https://arxiv.org/abs/2602.02151) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yuli Zhou, Qingxuan Chen, Luca Benini |
...
- **PDF**: https://arxiv.org/pdf/2602.02151
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
