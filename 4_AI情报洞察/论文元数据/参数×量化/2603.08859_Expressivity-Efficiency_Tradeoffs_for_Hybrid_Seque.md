...
citekey: cooper2026expressivity
...
pdf_url: "https://arxiv.org/pdf/2603.08859"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **作者** | John Cooper, Ilias Diakonikolas, Mingchen Ma |
...
- **PDF**: https://arxiv.org/pdf/2603.08859
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
