...
citekey: thillainathan2026authormix
...
pdf_url: "https://arxiv.org/pdf/2603.23069"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.23069](https://arxiv.org/abs/2603.23069) |
| **4×5分类** | 参数×低秩 |
| **来源** | deep_collect_v2_supp |
| **作者** | Sarubi Thillainathan, Ji-Ung Lee, Michael Sullivan |
...
- **PDF**: https://arxiv.org/pdf/2603.23069
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
