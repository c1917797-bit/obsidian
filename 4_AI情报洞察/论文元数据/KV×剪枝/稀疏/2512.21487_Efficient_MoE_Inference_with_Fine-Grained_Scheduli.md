...
pdf_url: "https://arxiv.org/pdf/2512.21487"
object: KV
method: 剪枝/稀疏
cell: "KV×剪枝/稀疏"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.21487](https://arxiv.org/abs/2512.21487) |
| **4×5分类** | KV×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Xinglin Pan, Shaohuai Shi, Wenxiang Lin |
...
- **PDF**: https://arxiv.org/pdf/2512.21487
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
