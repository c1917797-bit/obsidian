...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2507.19887](https://arxiv.org/abs/2507.19887) |
| **4×5分类** | 参数×低秩 |
...
- **PDF**: https://arxiv.org/pdf/2507.19887
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
