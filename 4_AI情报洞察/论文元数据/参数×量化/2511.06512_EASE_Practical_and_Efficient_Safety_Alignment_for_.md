...
| **作者** | Haonan Shi, Guoli Wang, Tu Ouyang |
...
- **PDF**: https://arxiv.org/pdf/2511.06512
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
