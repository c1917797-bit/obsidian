...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=7PKGMNcM0w"
pdf_url: ""
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
...
abstract: |
  ...
  To address this issue, we introduce Winner-Take-All (WTA) mecha
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Chenlin Zhou, Sihang Guo, Jiaqi Wang |
