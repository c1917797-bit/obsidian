...
abstract: |
  ...
  Speculative decoding (SD) leverages smaller models to efficiently propose future tokens, which are then verified by the L
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Matthieu Zimmer, Milan Gritta, Gerasimos Lampouras |
