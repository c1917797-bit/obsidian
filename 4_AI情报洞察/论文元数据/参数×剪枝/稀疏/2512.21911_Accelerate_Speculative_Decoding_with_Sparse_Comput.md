...
pdf_url: "https://arxiv.org/pdf/2512.21911"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects: []
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Jikai Wang, Jianchao Tan, Yuxuan Hu |
...
- **PDF**: https://arxiv.org/pdf/2512.21911
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
