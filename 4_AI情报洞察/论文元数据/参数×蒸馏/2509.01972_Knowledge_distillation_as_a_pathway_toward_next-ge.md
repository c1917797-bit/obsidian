...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.01972](https://arxiv.org/abs/2509.01972) |
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2 |
| **作者** | Long Jiang, Yang Yang, Ting Fong May Chui |
...
- **PDF**: https://arxiv.org/pdf/2509.01972
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
