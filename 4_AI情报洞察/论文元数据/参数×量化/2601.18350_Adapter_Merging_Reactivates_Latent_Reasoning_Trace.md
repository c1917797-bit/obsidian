...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2601.18350](https://arxiv.org/abs/2601.18350) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2601.18350
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
