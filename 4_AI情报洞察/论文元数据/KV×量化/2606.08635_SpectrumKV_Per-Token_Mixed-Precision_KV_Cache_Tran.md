...
pdf_url: "https://arxiv.org/pdf/2606.08635"
object: KV
method: 量化
cell: "KV×量化"
all_objects: []
...
abstract: |
  暂无摘要
key_innovation: "核心创新：提出混合精度KV缓存传输机制，优化大语言模型预填充和解码阶段的性能。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
- **PDF**: https://arxiv.org/pdf/2606.08635
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
