...
pdf_url: "https://arxiv.org/pdf/2605.09548"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
| **作者** | Yihong Liu, Raoyuan Zhao, Michael A. Hedderich |
...
- **PDF**: https://arxiv.org/pdf/2605.09548
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
