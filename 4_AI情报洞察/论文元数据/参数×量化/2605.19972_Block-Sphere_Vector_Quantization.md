...
pdf_url: "https://arxiv.org/pdf/2605.19972"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出Block-Sphere矢量量化，统一理论框架比较旋转量化方法。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2605.19972](https://arxiv.org/abs/2605.19972) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2605.19972
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
