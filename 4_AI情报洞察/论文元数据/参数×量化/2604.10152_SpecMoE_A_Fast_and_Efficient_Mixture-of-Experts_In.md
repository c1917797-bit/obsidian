...
pdf_url: "https://arxiv.org/pdf/2604.10152"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
key_innovation: "核心创新：提出SpecMoE，基于自辅助推测解码实现高效内存利用的MoE推理。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Jehyeon Bang, Eunyeong Cho, Ranggi Hwang |
...
- **PDF**: https://arxiv.org/pdf/2604.10152
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
