...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2510.27253](https://arxiv.org/abs/2510.27253) |
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2_supp |
| **作者** | Qiyan Deng, Changqian Zheng, Lianpeng Qiao |
...
- **PDF**: https://arxiv.org/pdf/2510.27253
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
