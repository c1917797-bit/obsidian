...
pdf_url: "https://arxiv.org/pdf/2508.11189"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.11189](https://arxiv.org/abs/2508.11189) |
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2 |
| **作者** | Chenyang Le, Yinfeng Xia, Huiyan Li |
...
- **PDF**: https://arxiv.org/pdf/2508.11189
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
