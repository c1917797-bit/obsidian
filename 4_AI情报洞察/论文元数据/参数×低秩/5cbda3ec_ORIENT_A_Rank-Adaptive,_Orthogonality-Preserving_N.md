...
citekey: matsumoto2026orient
title: "ORIENT: A Rank-Adaptive, Orthogonality-Preserving Neural Architecture"
authors:
  - "Kazunori Matsumoto"
  - "Shuichiro Haruta"
  - "Tomoya Kaichi"
...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=h5nQybadry"
pdf_url: ""
object: 参数
method: 低秩
cell: "参数×低秩"
...
abstract: |
  ...
  It achieves high parallelism by arranging mutually non-interfering rotations at each layer, an
...
| **4×5分类** | 参数×低秩 |
| **来源** | openreview |
| **作者** | Kazunori Matsumoto, Shuichiro Haruta, Tomoya Kaichi |
