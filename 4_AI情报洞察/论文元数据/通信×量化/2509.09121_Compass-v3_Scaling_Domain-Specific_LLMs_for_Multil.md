...
pdf_url: "https://arxiv.org/pdf/2509.09121"
object: 通信
method: 量化
cell: "通信×量化"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.09121](https://arxiv.org/abs/2509.09121) |
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Sophia Maria |
...
- **PDF**: https://arxiv.org/pdf/2509.09121
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
