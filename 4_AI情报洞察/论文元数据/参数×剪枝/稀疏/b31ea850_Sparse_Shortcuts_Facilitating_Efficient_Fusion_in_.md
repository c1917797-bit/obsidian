...
abstract: |
  ...
  In vision-language models, for instance, aligning modalities using only high-level visual features often discards the rich semantic information presen
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Jingrui Zhang, Yong Zhang, Feng Liang |
