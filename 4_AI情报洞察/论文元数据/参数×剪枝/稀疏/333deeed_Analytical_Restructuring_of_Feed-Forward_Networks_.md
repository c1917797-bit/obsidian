...
abstract: |
  ...
  We propose a broadly applicable post-training framework that improves this performance–cost trade-off by enabling the rapid, analytical
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Zehua Pei, Hui-Ling Zhen, Lancheng Zou |
