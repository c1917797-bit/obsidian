...
pdf_url: "https://arxiv.org/pdf/2601.10043"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects: []
...
key_innovation: "将指令微调和LoRA结合应用于LLaMA-3-8B模型，提升金融命名实体识别的准确性"
performance: "未提数字"
code_url: ""
hf_model: ""
status: unread
...
- **PDF**: https://arxiv.org/pdf/2601.10043
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
