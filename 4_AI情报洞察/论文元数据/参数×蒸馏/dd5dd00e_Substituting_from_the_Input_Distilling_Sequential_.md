...
citekey: lan2026substituting
title: "Substituting from the Input: Distilling Sequential Computation in Transformer Language Models"
authors:
  - "Zixuan Lan"
  - "Jiamin Yang"
  - "Yanhong Li"
...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=EbVpH8oSRx"
pdf_url: ""
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
...
| **4×5分类** | 参数×蒸馏 |
| **来源** | openreview |
| **作者** | Zixuan Lan, Jiamin Yang, Yanhong Li |
