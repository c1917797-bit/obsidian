...
pdf_url: "https://arxiv.org/pdf/2512.21323"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2 |
| **作者** | Felix Draxler, Justus Will, Farrin Marouf Sofian |
...
- **PDF**: https://arxiv.org/pdf/2512.21323
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
