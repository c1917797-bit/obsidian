...
arxiv_id: "2602.10455"
doi: ""
url: "https://arxiv.org/abs/2602.10455"
pdf_url: "https://arxiv.org/pdf/2602.10455"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出UG-Sep框架，实现用户侧计算可重用，降低大规模推荐模型训练和推理成本。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.10455](https://arxiv.org/abs/2602.10455) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_1year |
| **作者** | Hui Lu, Zheng Chai, Shipeng Bai |
...
- **PDF**: https://arxiv.org/pdf/2602.10455
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
