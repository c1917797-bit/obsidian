...
pdf_url: "https://arxiv.org/pdf/2508.20351"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.20351](https://arxiv.org/abs/2508.20351) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Zhirui Chen, Wei Shen, Jiashui Huang |
...
- **PDF**: https://arxiv.org/pdf/2508.20351
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
