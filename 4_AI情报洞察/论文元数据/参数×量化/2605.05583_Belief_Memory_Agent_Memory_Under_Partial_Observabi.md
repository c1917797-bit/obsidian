...
pdf_url: "https://arxiv.org/pdf/2605.05583"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "提出BeliefMem方法，让智能体在部分可观测环境下存储和更新多可能性信念记忆，避免自强化错误。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Junfeng Liao, Qizhou Wang, Jianing Zhu |
