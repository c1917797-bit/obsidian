...
pdf_url: "https://arxiv.org/pdf/2605.17291"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **作者** | Weichu Xie, Haozhe Zhao, Wenpu Liu |
...
- **PDF**: https://arxiv.org/pdf/2605.17291
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
