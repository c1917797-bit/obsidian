...
pdf_url: "https://arxiv.org/pdf/2603.11564"
object: KV
method: 量化
cell: "KV×量化"
all_objects:
...
key_innovation: "核心创新：提出位置感知伪查询，实现解码对齐的KV缓存压缩，提升大语言模型推理效率。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.11564](https://arxiv.org/abs/2603.11564) |
| **4×5分类** | KV×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Zhenxu Tian, Yi Su, Juntao Li |
...
- **PDF**: https://arxiv.org/pdf/2603.11564
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
