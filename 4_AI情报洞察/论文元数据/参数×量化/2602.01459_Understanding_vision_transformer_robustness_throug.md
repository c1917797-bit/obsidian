...
citekey: kuang2026understanding
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.01459](https://arxiv.org/abs/2602.01459) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2602.01459
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
