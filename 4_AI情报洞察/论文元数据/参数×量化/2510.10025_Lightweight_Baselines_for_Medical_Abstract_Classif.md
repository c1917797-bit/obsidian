...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2510.10025](https://arxiv.org/abs/2510.10025) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Jiaqi Liu, Tong Wang, Su Liu |
...
- **PDF**: https://arxiv.org/pdf/2510.10025
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
