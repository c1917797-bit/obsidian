...
pdf_url: "https://arxiv.org/pdf/2508.03865"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.03865](https://arxiv.org/abs/2508.03865) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yajie Luo, Yihong Wu, Muzhi Li |
...
- **PDF**: https://arxiv.org/pdf/2508.03865
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
