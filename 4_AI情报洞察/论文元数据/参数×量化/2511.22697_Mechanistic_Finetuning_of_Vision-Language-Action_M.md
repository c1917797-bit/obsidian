...
pdf_url: "https://arxiv.org/pdf/2511.22697"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
| **作者** | Chancharik Mitra, Yusen Luo, Raj Saravanan |
...
- **PDF**: https://arxiv.org/pdf/2511.22697
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
