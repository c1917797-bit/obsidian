...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=PI8coYOXia"
pdf_url: ""
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
...
abstract: |
  ...
  This coarse-to-fine strategy reduces the number of expensive de
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Arundhati Shanbhag, Brian Bernhard Moser, Tobias Christian Nauen |
