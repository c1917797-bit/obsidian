...
pdf_url: "https://arxiv.org/pdf/2507.16109"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **作者** | Zihao Chen, Mohammad Goudarzi, Adel Nadjaran Toosi |
...
- **PDF**: https://arxiv.org/pdf/2507.16109
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
