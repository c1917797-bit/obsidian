...
pdf_url: "https://arxiv.org/pdf/2605.09693"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Santhosh Kumar Ramakrishnan, Carl Vondrick, Raja Giryes |
...
- **PDF**: https://arxiv.org/pdf/2605.09693
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
