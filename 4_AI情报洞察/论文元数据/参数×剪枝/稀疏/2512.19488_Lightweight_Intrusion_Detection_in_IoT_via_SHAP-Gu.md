...
citekey: benaddi2025lightweight
...
pdf_url: "https://arxiv.org/pdf/2512.19488"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.19488](https://arxiv.org/abs/2512.19488) |
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Hafsa Benaddi, Mohammed Jouhari, Nouha Laamech |
...
- **PDF**: https://arxiv.org/pdf/2512.19488
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
