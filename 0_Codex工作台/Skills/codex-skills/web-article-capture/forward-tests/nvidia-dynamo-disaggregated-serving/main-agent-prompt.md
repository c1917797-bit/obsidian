# Main Agent Prompt: Run NVIDIA Dynamo Disaggregated Serving Web Capture Forward Test
...
Paste the URLs from `forward-tests/nvidia-dynamo-disaggregated-serving/candidate/input/urls.txt` into the `<assigned URLs>` slot. Do not include this file path in the child prompt.
