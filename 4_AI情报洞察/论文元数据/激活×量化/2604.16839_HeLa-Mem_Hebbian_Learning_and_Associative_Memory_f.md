...
pdf_url: "https://arxiv.org/pdf/2604.16839"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
| **作者** | Jinchang Zhu, Jindong Li, Cheng Zhang |
...
- **PDF**: https://arxiv.org/pdf/2604.16839
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
