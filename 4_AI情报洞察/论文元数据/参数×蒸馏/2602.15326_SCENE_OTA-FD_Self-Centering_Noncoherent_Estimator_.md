...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.15326](https://arxiv.org/abs/2602.15326) |
| **4×5分类** | 参数×蒸馏 |
...
- **PDF**: https://arxiv.org/pdf/2602.15326
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
