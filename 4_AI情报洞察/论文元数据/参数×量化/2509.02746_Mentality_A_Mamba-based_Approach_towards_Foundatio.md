...
citekey: panchavati2025mentality
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.02746](https://arxiv.org/abs/2509.02746) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2509.02746
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
