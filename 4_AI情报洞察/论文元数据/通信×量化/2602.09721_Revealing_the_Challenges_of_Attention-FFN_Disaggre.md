...
pdf_url: "https://arxiv.org/pdf/2602.09721"
object: 通信
method: 量化
cell: "通信×量化"
all_objects:
...
key_innovation: "核心创新：首次系统分析AFD架构性能边界，揭示其硬件瓶颈与通信瓶颈。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Guowei Liu, Hongming Li, Yaning Guo |
...
- **PDF**: https://arxiv.org/pdf/2602.09721
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
