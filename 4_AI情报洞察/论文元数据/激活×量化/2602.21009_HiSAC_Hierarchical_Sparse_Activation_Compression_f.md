...
pdf_url: "https://arxiv.org/pdf/2602.21009"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.21009](https://arxiv.org/abs/2602.21009) |
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Kun Yuan, Junyu Bi, Daixuan Cheng |
...
- **PDF**: https://arxiv.org/pdf/2602.21009
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
