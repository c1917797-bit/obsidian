...
pdf_url: "https://arxiv.org/pdf/2603.02737"
object: KV
method: 量化
cell: "KV×量化"
all_objects:
...
key_innovation: "核心创新：提出晶圆级SRAM存内计算架构，采用令牌级流水线提升利用率并减少存储需求。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.02737](https://arxiv.org/abs/2603.02737) |
| **4×5分类** | KV×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yiqi Liu, Yudong Pan, Mengdi Wang |
...
- **PDF**: https://arxiv.org/pdf/2603.02737
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
