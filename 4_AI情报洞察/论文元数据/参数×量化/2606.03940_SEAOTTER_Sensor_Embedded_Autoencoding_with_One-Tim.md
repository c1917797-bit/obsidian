...
citekey: jacobellis2026seaotter
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2606.03940](https://arxiv.org/abs/2606.03940) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2606.03940
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
