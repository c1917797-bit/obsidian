...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.11661](https://arxiv.org/abs/2508.11661) |
| **4×5分类** | KV×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Ziyi Cao, Qingyi Si, Jingbin Zhang |
...
- **PDF**: https://arxiv.org/pdf/2508.11661
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
