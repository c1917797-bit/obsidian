...
pdf_url: "https://arxiv.org/pdf/2509.23384"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.23384](https://arxiv.org/abs/2509.23384) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yue Zhang, Yuansheng Chen, Xuan Mo |
...
- **PDF**: https://arxiv.org/pdf/2509.23384
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
