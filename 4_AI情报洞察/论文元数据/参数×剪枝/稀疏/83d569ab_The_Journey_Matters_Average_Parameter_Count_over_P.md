...
abstract: |
  ...
  While many focus on post-training pruning, sparse pre-training--which combines pruning and pre-training into a single phase--provides a
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | arXiv |
| **作者** | Tian Jin, Ahmed Imtiaz Humayun, Utku Evci |
