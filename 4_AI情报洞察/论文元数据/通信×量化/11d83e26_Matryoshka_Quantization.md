...
all_methods: []
abstract: |
  Quantizing model weights is critical for reducing
  ...
  known to severely degrade model quality. Consequently,
...
| **4×5分类** | 通信×量化 |
| **来源** | arXiv |
| **作者** | Pranav Ajit Nair, Puranjay Datta, Jeff Dean |
