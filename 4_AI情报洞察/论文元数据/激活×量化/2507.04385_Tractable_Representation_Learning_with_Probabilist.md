...
pdf_url: "https://arxiv.org/pdf/2507.04385"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2507.04385](https://arxiv.org/abs/2507.04385) |
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Steven Braun, Sahil Sidheekh, Antonio Vergari |
...
- **PDF**: https://arxiv.org/pdf/2507.04385
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
