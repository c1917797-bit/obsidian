...
pdf_url: "https://arxiv.org/pdf/2603.24002"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "提出随机无维度零阶估计器，降低高维高阶PINNs的空间复杂度并消除反向传播内存负担。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.24002](https://arxiv.org/abs/2603.24002) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2603.24002
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
