...
abstract: |
  ...
  Recently, there is an increasing interest in quantizing weights to extremely low precision while offsetting the resulting error with low-rank, hig
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Cheng Zhang, Jeffrey T. H. Wong, Can Xiao |
