...
citekey: kalogiannis2025attention
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.15503](https://arxiv.org/abs/2512.15503) |
| **4×5分类** | 通信×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Konstantinos Kalogiannis, Ahmed Mohamed Hussain, Hexu Li |
...
- **PDF**: https://arxiv.org/pdf/2512.15503
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
