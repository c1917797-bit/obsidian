...
pdf_url: "https://arxiv.org/pdf/2511.06057"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2511.06057](https://arxiv.org/abs/2511.06057) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Bingbing Wang, Zhengda Jin, Bin Liang |
...
- **PDF**: https://arxiv.org/pdf/2511.06057
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
