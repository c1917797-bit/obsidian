...
abstract: |
  ...
  However, the discretization process in generative transformers can introduce motion errors, while the sampling process in diffusion
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Linnan Tu, Lingwei Meng, Zongyi Li |
