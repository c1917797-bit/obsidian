...
key_innovation: "核心创新：提出通过缩放初始token权重来克服U形注意力偏差，提升长文本处理能力。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.13109](https://arxiv.org/abs/2512.13109) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Zewen Qiang, Sendong Zhao, Haochun Wang |
...
- **PDF**: https://arxiv.org/pdf/2512.13109
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
