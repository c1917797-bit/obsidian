...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.06001](https://arxiv.org/abs/2508.06001) |
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Kai Zhang, Peng Wang, Sai Bi |
...
- **PDF**: https://arxiv.org/pdf/2508.06001
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
