...
pdf_url: "https://arxiv.org/pdf/2605.20706"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
key_innovation: "核心创新：实现浏览器中多精度大语言模型的内存高效、跨设备性能可移植推理。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2605.20706](https://arxiv.org/abs/2605.20706) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Reese Levine, Rithik Sharma, Nikhil Jain |
...
- **PDF**: https://arxiv.org/pdf/2605.20706
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
