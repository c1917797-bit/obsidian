...
key_innovation: "核心创新：提出软冻结机制和熵引导恢复，实现大模型推理的次线性内存增长。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.11221](https://arxiv.org/abs/2512.11221) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_1year |
| **作者** | Adilet Metinov, Gulida M. Kudakeeva, Bolotbek uulu Nursultan |
...
- **PDF**: https://arxiv.org/pdf/2512.11221
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
