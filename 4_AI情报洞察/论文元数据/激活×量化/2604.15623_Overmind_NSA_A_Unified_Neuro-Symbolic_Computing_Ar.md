...
pdf_url: "https://arxiv.org/pdf/2604.15623"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Weilun Wang, Zirui Wang, Wantong Li |
...
- **PDF**: https://arxiv.org/pdf/2604.15623
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
