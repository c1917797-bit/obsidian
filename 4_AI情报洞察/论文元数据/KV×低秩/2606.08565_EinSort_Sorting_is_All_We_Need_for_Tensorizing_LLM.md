...
pdf_url: "https://arxiv.org/pdf/2606.08565"
object: KV
method: 低秩
cell: "KV×低秩"
all_objects:
...
key_innovation: "核心创新：提出通过排序实现张量化的自适应方法，提升大模型压缩效果。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2606.08565](https://arxiv.org/abs/2606.08565) |
| **4×5分类** | KV×低秩 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2606.08565
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
