...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=xbW0fytR2D"
pdf_url: ""
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
...
abstract: |
  ...
  Theoretical equivalence with the original SHOPCA formulation is established, and error bounds linked to PCA residu
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | Renjie Xu, Chong Wu, Zhuoheng Ran |
