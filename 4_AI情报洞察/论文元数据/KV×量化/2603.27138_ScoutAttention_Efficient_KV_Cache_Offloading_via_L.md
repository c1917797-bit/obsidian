...
citekey: zhang2026scoutattention
...
pdf_url: "https://arxiv.org/pdf/2603.27138"
object: KV
method: 量化
cell: "KV×量化"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.27138](https://arxiv.org/abs/2603.27138) |
| **4×5分类** | KV×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Qiuyang Zhang, Kai Zhou, Ding Tang |
...
- **PDF**: https://arxiv.org/pdf/2603.27138
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
