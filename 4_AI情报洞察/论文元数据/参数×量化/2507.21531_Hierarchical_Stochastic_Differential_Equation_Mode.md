...
citekey: rajaei2025hierarchical
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2507.21531](https://arxiv.org/abs/2507.21531) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Pedram Rajaei, Maryam Ostadsharif Memar, Navid Ziaei |
...
- **PDF**: https://arxiv.org/pdf/2507.21531
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
