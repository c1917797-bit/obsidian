...
pdf_url: "https://arxiv.org/pdf/2603.17803"
object: 激活
method: 量化
cell: "激活×量化"
all_objects:
...
key_innovation: "**核心创新**：首次提出利用多SSD协同激活机制优化大语言模型推理的KV缓存卸载。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.17803](https://arxiv.org/abs/2603.17803) |
| **4×5分类** | 激活×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Tuowei Wang, Liyun Chu, Ruwen Fan |
...
- **PDF**: https://arxiv.org/pdf/2603.17803
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
