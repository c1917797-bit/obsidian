...
citekey: yangndattentionpredictor
...
abstract: |
  ...
  To compress the KV cache, recent methods identify critical KV tokens through static modeling of attention s
...
| **4×5分类** | KV×量化 |
| **来源** | arXiv |
| **作者** | Qingyue Yang, Jie Wang, Xing Li |
