...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=l9MqBHCb91"
pdf_url: ""
object: 参数
method: 低秩
cell: "参数×低秩"
...
abstract: |
  ...
  To address this, we propose Rollout Response Recomposition (RoRecomp), a plug-and-play method that guides models toward
...
| **4×5分类** | 参数×低秩 |
| **来源** | openreview |
| **作者** | Gang Li, Yulei Qin, Xiaoyu Tan |
