...
pdf_url: "https://arxiv.org/pdf/2606.17081"
object: KV
method: 量化
cell: "KV×量化"
all_objects:
...
key_innovation: "核心创新：将博弈论首次应用于分析解聚推理架构，揭示硬件资源分配、缓存策略和请求路由中的竞争与合作机制。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
- **PDF**: https://arxiv.org/pdf/2606.17081
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
