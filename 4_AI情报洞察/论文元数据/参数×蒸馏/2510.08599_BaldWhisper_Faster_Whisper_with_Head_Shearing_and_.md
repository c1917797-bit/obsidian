...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2510.08599](https://arxiv.org/abs/2510.08599) |
| **4×5分类** | 参数×蒸馏 |
...
- **PDF**: https://arxiv.org/pdf/2510.08599
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
