...
pdf_url: "https://arxiv.org/pdf/2603.18074"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
| **作者** | Yi Yu, Junzhuo Ma, Chenghuang Shen |
...
- **PDF**: https://arxiv.org/pdf/2603.18074
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
