...
pdf_url: "https://arxiv.org/pdf/2606.19993"
object: 参数
method: 低秩
cell: "参数×低秩"
all_objects:
...
| **作者** | Nico Harder, Daniel Becking, Karsten Mueller |
...
- **PDF**: https://arxiv.org/pdf/2606.19993
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
