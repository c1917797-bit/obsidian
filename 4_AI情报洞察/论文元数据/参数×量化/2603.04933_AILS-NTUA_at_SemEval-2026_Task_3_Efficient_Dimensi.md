...
pdf_url: "https://arxiv.org/pdf/2603.04933"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2603.04933](https://arxiv.org/abs/2603.04933) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2_supp |
| **作者** | Stavros Gazetas, Giorgos Filandrianos, Maria Lymperaiou |
...
- **PDF**: https://arxiv.org/pdf/2603.04933
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
