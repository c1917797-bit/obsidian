...
pdf_url: "https://arxiv.org/pdf/2606.29337"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
key_innovation: "核心创新：结合MixQ混合精度和SmoothQuant逐通道平滑技术，实现大模型Wan2.2在4比特权重和激活下的高效推理。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2606.29337](https://arxiv.org/abs/2606.29337) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2606.29337
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
