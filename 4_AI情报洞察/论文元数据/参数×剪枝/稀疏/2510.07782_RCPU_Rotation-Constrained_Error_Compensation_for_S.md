...
pdf_url: "https://arxiv.org/pdf/2510.07782"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects:
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2510.07782](https://arxiv.org/abs/2510.07782) |
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | deep_collect_v2_supp |
| **作者** | Shuichiro Haruta, Kazunori Matsumoto, Zhi Li |
...
- **PDF**: https://arxiv.org/pdf/2510.07782
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
