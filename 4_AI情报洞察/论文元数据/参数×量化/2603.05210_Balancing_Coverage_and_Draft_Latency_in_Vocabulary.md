...
pdf_url: "https://arxiv.org/pdf/2603.05210"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
key_innovation: "提出了一种平衡词汇覆盖率和草稿模型延迟的词汇修剪方法，用于加速大语言模型的推测解码。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
- **PDF**: https://arxiv.org/pdf/2603.05210
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
