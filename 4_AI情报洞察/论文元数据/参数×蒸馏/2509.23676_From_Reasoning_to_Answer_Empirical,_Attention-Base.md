...
pdf_url: "https://arxiv.org/pdf/2509.23676"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.23676](https://arxiv.org/abs/2509.23676) |
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2_supp |
| **作者** | Jue Zhang, Qingwei Lin, Saravan Rajmohan |
...
- **PDF**: https://arxiv.org/pdf/2509.23676
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
