...
pdf_url: "https://arxiv.org/pdf/2604.13349"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
abstract: |
  暂无摘要
key_innovation: "核心创新：在多智能体大模型协作中，提出了一种保留信息的潜在空间压缩方法。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv 2026 |
| **arXiv** | [2604.13349](https://arxiv.org/abs/2604.13349) |
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
...
- **PDF**: https://arxiv.org/pdf/2604.13349
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
