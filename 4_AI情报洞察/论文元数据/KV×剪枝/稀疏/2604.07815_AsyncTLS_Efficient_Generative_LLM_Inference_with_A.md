...
pdf_url: "https://arxiv.org/pdf/2604.07815"
object: KV
method: 剪枝/稀疏
cell: "KV×剪枝/稀疏"
all_objects:
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2604.07815](https://arxiv.org/abs/2604.07815) |
| **4×5分类** | KV×剪枝/稀疏 |
| **来源** | deep_collect_v2 |
| **作者** | Yuxuan Hu, Jianchao Tan, Jiaqi Zhang |
...
- **PDF**: https://arxiv.org/pdf/2604.07815
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
