...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.23232](https://arxiv.org/abs/2509.23232) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_1year |
| **作者** | Bingshuai Liu, Ante Wang, Zijun Min |
...
- **PDF**: https://arxiv.org/pdf/2509.23232
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
