...
pdf_url: "https://arxiv.org/pdf/2604.03957"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
| **作者** | Yifu Ding, Xianglong Liu, Shenghao Jin |
...
- **PDF**: https://arxiv.org/pdf/2604.03957
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
