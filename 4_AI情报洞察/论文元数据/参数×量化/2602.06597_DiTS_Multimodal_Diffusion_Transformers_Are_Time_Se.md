...
pdf_url: "https://arxiv.org/pdf/2602.06597"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **作者** | Haoran Zhang, Haixuan Liu, Yong Liu |
...
- **PDF**: https://arxiv.org/pdf/2602.06597
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
