...
pdf_url: "https://arxiv.org/pdf/2511.16191"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2511.16191](https://arxiv.org/abs/2511.16191) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2511.16191
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
