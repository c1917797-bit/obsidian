...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.01598](https://arxiv.org/abs/2508.01598) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | En Yu, Jie Lu, Kun Wang |
...
- **PDF**: https://arxiv.org/pdf/2508.01598
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
