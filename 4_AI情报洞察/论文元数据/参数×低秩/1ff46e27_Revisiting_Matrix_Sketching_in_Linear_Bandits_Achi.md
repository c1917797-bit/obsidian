...
abstract: |
  ...
  However, this computational efficiency comes with a fundamental pitfall: when the streaming matrix exhibits
...
| **4×5分类** | 参数×低秩 |
| **来源** | openreview |
| **作者** | Dongxie Wen, Hanyan Yin, Xiao Zhang |
