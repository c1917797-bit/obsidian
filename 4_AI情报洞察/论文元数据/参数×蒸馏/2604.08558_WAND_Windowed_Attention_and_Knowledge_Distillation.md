...
pdf_url: "https://arxiv.org/pdf/2604.08558"
object: 参数
method: 蒸馏
cell: "参数×蒸馏"
all_objects: []
...
key_innovation: "核心创新：提出WAND框架，融合全局持久注意力和滑动窗口注意力，实现AR-TTS模型计算和内存复杂度恒定化。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2604.08558](https://arxiv.org/abs/2604.08558) |
| **4×5分类** | 参数×蒸馏 |
| **来源** | deep_collect_v2 |
| **作者** | Hanna Lee, Tan Dat Nguyen, Jaehoon Kang |
...
- **PDF**: https://arxiv.org/pdf/2604.08558
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
