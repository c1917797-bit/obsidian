...
abstract: |
  ...
  Instead of relying on post-hoc methods, we present \textbf{MoE-X}, a mixture-of-experts (MoE) language model designed to be \emph{intrinsically}
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Xingyi Yang, Constantin Venhoff, Ashkan Khakzar |
