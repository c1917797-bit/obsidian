...
pdf_url: "https://arxiv.org/pdf/2605.31183"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects: []
...
- **PDF**: https://arxiv.org/pdf/2605.31183
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
