...
abstract: |
  ...
  Masked-based autoregressive models have demonstrated promising image generation capability in continuous space. Howev
...
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | Hu Yu, Biao Gong, Hangjie Yuan |
