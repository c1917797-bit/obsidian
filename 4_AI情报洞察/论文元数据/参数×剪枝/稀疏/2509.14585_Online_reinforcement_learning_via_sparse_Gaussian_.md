...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.14585](https://arxiv.org/abs/2509.14585) |
| **4×5分类** | 参数×剪枝/稀疏 |
...
- **PDF**: https://arxiv.org/pdf/2509.14585
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
