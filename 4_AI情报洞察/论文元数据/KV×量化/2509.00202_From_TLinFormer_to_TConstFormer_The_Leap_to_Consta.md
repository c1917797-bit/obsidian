...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2509.00202](https://arxiv.org/abs/2509.00202) |
| **4×5分类** | KV×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Zhongpan Tang |
...
- **PDF**: https://arxiv.org/pdf/2509.00202
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
