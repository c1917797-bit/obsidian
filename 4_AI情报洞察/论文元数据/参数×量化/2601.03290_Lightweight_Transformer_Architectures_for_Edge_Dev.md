...
pdf_url: "https://arxiv.org/pdf/2601.03290"
object: 参数
method: 量化
cell: "参数×量化"
all_objects:
...
key_innovation: "核心创新：综述轻量级Transformer架构在边缘设备实时应用中的模型压缩、量化、剪枝和知识蒸馏技术。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2601.03290](https://arxiv.org/abs/2601.03290) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2601.03290
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
