...
arxiv_id: "1902.08134"
doi: ""
url: "https://arxiv.org/abs/1902.08134"
pdf_url: "https://arxiv.org/pdf/1902.08134"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出域划分网络（DoPaNet）解决对抗训练中的模式崩溃问题。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2019 |
| **会议/期刊** | MLSys 2020 |
| **arXiv** | [1902.08134](https://arxiv.org/abs/1902.08134) |
| **4×5分类** | 参数×量化 |
| **来源** | arXiv |
| **作者** | N/A |
...
- **PDF**: https://arxiv.org/pdf/1902.08134
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
