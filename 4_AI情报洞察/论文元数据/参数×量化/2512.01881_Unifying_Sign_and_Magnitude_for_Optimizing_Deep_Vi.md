...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2512.01881](https://arxiv.org/abs/2512.01881) |
| **4×5分类** | 参数×量化 |
...
- **PDF**: https://arxiv.org/pdf/2512.01881
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
