...
citekey: bui2026from
title: "From Scarcity to Efficiency: Preference-Guided Learning for Sparse-Reward Multi-Agent Reinforcement Learning"
authors:
  - "The Viet Bui"
  - "Tien Anh Mai"
  - "Thanh Hong Nguyen"
...
arxiv_id: ""
doi: ""
url: "https://openreview.net/forum?id=7ei1uOYUY0"
pdf_url: ""
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
...
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | openreview |
| **作者** | The Viet Bui, Tien Anh Mai, Thanh Hong Nguyen |
