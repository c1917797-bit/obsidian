...
pdf_url: "https://arxiv.org/pdf/2606.23743"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Yitong Li, Junsong Chen, Haopeng Li |
...
- **PDF**: https://arxiv.org/pdf/2606.23743
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
