...
pdf_url: "https://arxiv.org/pdf/2602.16054"
object: KV
method: 量化
cell: "KV×量化"
all_objects:
...
key_innovation: "提出跨层注意力聚合机制，加速大语言模型预填充阶段。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.16054](https://arxiv.org/abs/2602.16054) |
| **4×5分类** | KV×量化 |
| **来源** | deep_collect_v2 |
...
- **PDF**: https://arxiv.org/pdf/2602.16054
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
