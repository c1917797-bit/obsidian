...
pdf_url: "https://arxiv.org/pdf/2604.19021"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出FG$^2$-GDN，在门控增量网络中引入双重细粒度学习率控制机制。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2604.19021](https://arxiv.org/abs/2604.19021) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Pingwei Sun, Yuxuan Hu, Jianchao Tan |
...
- **PDF**: https://arxiv.org/pdf/2604.19021
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
