...
pdf_url: "https://arxiv.org/pdf/2508.20403"
object: 参数
method: 剪枝/稀疏
cell: "参数×剪枝/稀疏"
all_objects: []
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2508.20403](https://arxiv.org/abs/2508.20403) |
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | deep_collect_v2_supp |
| **作者** | Tiancheng Zhao, Zekun Yin, Huihai An |
...
- **PDF**: https://arxiv.org/pdf/2508.20403
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
