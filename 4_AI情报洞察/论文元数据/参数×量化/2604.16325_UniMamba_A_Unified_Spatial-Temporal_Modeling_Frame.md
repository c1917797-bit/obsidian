...
pdf_url: "https://arxiv.org/pdf/2604.16325"
object: 参数
method: 量化
cell: "参数×量化"
all_objects: []
...
key_innovation: "核心创新：提出UniMamba，整合状态空间模型和注意力机制，实现时空统一建模。"
performance: "待精读后填写"
code_url: ""
hf_model: ""
status: unread
...
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Xingsheng Chen, Xianpei Mu, Deyu Yi |
...
- **PDF**: https://arxiv.org/pdf/2604.16325
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
