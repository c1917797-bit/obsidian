...
| **年份** | 2026 |
| **会议/期刊** | arXiv |
| **arXiv** | [2602.04166](https://arxiv.org/abs/2602.04166) |
| **4×5分类** | 参数×剪枝/稀疏 |
| **来源** | deep_collect_v2_supp |
| **作者** | Meiling Jin, Fei Wang, Xiaoyun Yuan |
...
- **PDF**: https://arxiv.org/pdf/2602.04166
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
