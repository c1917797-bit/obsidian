...
citekey: badar2025differentiable
...
| **年份** | 2025 |
| **会议/期刊** | arXiv |
| **arXiv** | [2510.16088](https://arxiv.org/abs/2510.16088) |
| **4×5分类** | 参数×量化 |
| **来源** | deep_collect_v2 |
| **作者** | Zia Badar |
...
- **PDF**: https://arxiv.org/pdf/2510.16088
- **代码**: （精读时查找GitHub链接）
- **HuggingFace模型**: （如适用）
